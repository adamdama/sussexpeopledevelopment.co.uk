...
class plgSystemJblibrary extends JPlugin {
    ...
    function onAfterInitialise() {
		...
		if(in_array($itemid,$menus)){
				 ...
				 * There is a bug getting the active menu and its assigned template.
				 * So just the default template will be opened.
				 * Calling directly each framework fix that
				 */
				...
				if ($jQueryVersion == '1.6') {
						$this->_jqpath = 'http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js';
